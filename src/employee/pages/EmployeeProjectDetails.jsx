...
import { getEmployeeProjectDetailsAPI } from "../../services/allAPI";
...
const EmployeeProjectDetails = () => {
  ...
  const employeeProjectDetails = async (projectId) => {
    try {
      const result = await getEmployeeProjectDetailsAPI(projectId);
      console.log(result.data);
      setTasks(result.data.Tasks||[]);
      setProjectStats(result.data.employeeProjectStats||{});
      setMembers(result.data.members||[]);
      setProject(result.data.project||[]);
    } catch (err) {
      console.log(err);
      toast.warning("Data fetching failed");
    }
  };
