          ...
          <div className=" w-[90%] md:max-w-xl p-6 shadow-3xl rounded-2xl border border-gray-300 mt-5  shadow-2xl shadow-purple-300">
            <form className="p-4 flex flex-col justify-between gap-y-5">
              ...
              <div className="w-full mt-4">
                <Link to={'/login'}><button className="w-full bg-[linear-gradient(135deg,hsl(262,83%,58%)0%,hsl(340,82%,65%)_100%)] text-white rounded-lg py-4 px-3 text-lg font-bold active:opacity-80  transition duration-300">Create Account</button></Link>
              </div>
              <hr className="w-full border-gray-300 mt-4"/>
              <div className="flex justify-between items-center gap-4">
                <div className="border border-gray-300 text-lg py-2 px-5 w-full text-[#0F172A] font-medium"><FontAwesomeIcon icon={faGoogle} className="mx-3"/>Google</div>
                <div className="w-full border border-gray-300 text-lg py-2 px-5 text-[#0F172A] font-medium"><FontAwesomeIcon icon={faGithub} className="mx-3"/>Github</div>
              </div>
              <div>
                <p className="text-[#64748B] text-sm text-center font-medium">Already Have an Account?<Link to={'/login'}><span className="font-medium text-purple-500 mx-3">Sign in</span></Link></p>
              </div>
            </form>
          </div>
        </div>
